...
\subsection*{Education}
  \begin{itemize}
    ...
    \item[]
    {\href{http://www.uwaterloo.ca}{\textbf{Brown University}} \hfill
      \textbf{Providence, RI}}
    \\
...
\item[Languages:] \textbf{Prefer:} Java, Python \textbf{Have Used:} Racket, Pyret,
  ...
  \item[Accomplishments:] Eagle Scout, National AP Scholar, YouTube 10000 Subscribers, Student Body Vice President, Coke Scholar Regional Finalist, USA Computing Olympiad Silver Division, Juniper Networks Engineering Scholarship
\end{description}
